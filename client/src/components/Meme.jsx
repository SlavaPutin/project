...
const Meme = observer(({meme, onLikeSuccess, isMatch}) => {
    ...
    const DeleteFun = (postId) => {
        if(isMatch){
            PostStore.deletePost(postId)
        } else if(UserStore.isAdmin){
            PostStore.deletePostAdmin(postId)
        }
    ...
    return(
        <div className='meme' onClick={() => naavigate(`/memes/${meme.id}`)}>
                    ...
                    <div className="wrap-nameandcont">
                        <header>
                            <div className="wrap-name">
                                <Link className="name" to={`/${meme.author?.id}`} onClick={stopTrigger}>
                        ...
                        <div className="wrap-textandimg">
                            ...
                            <div className="wrap-img" onClick={stopTrigger}>
                            ...
                            <footer className="likeandcome">
                                <div className="wrap-like-coments">
                                    <button className="like" onClick={(e) => {e.stopPropagation(); toggleLike()}}>
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <button className="coment" onClick={() => naavigate(`/memes/${meme.id}`)}>
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    {(isMatch || UserStore.isAdmin) && <><button className="delete" onClick={(e) => {e.stopPropagation(); setModal(true)}}>
                                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <DeleteModal style={{display: modal ? 'flex' : "none"}} setVisible={setModal} Deletefun={DeleteFun} id={meme.id} visible={modal} >мем</DeleteModal></>
                                    }
                                </div>
                            </footer>
                        </div>  
