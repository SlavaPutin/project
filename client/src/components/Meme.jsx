                    ...
                    <div className="wrap-nameandcont">
                        <header>
                            <div className="wrap-name">
                                <Link className="name" to={`/${meme.author?.id}`}>
                        ...
                        <div className="wrap-textandimg">
                            ...
                            <footer className="likeandcome">
                                <div className="wrap-like-coments">
                                    ...
                                    {isMatch && <><button className="delete" onClick={() => setModal(true)}>
                                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <DeleteModal style={{display: modal ? 'flex' : "none"}} setVisible={setModal} Deletefun={DeleteFun} id={meme.id} visible={modal} text={"мем"}/></>
                                    }
                                </div>
                            </footer>
                        </div>
