...
const ModalNewName = ({value, setValue, visible,  setVisible, style, onSave}) => {
    ...
    return(
        <div className="wrap-modal-center" style={style} onClick={() => setVisible(false)}>
            <div className="wrap-modal" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="wrap-input-new-name">
                    <input 
                        type="text"
                ...
                <button onClick={onSave} className="save-name-btn" type="submit">Сохранить</button>
            </div>
        </div>
    )
}
